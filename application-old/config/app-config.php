...
*
*/
define('APP_BASE_URL', 'https://portal.lamtanssystems.com/');
...
*/
define('APP_ENC_KEY', 'db0fd8ce11c96f3f1bfb158a71f97fca');
 ...
 */
define('APP_DB_USERNAME', 'u817359048_perfex');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Perfex@0480');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'u817359048_perfex');
