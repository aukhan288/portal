...
$('#lead_form').on('submit', function(event) {
    ...
    $.ajax({
        url: formAction, // Use the form action URL
        type: form.attr('method'), // Form method (GET/POST)
...
$('#status').change(function() {
        ...
        var formAction = $('#client_status_form').attr('action');
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Optionally, you can update the page content here
            },
            error: function(xhr, status, error) {
